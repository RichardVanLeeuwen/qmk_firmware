...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NAVI] = LAYOUT_5x6(
    ...
    QK_BOOT,KC_HOME,KC_PGUP,KC_PGDN,KC_END ,QK_BOOT,                          _______,_______,_______,_______,_______,_______,
  ...
  [_MEDIA] = LAYOUT_5x6(
      ...
      _______,KC_BRIU,KC_BRID,KC_PSCR,KC_CAPS,QK_BOOT,                        _______,_______,_______,_______,_______,_______,
                      _______,_______,                                                        _______,_______,
                                      _______,_______,                        _______,_______,
                                      _______,_______,                        _______,_______,
                                      _______,_______,                        _______,_______
  ...
  [_SYMBOLS] = LAYOUT_5x6(
      ...
      _______,_______,_______,_______,_______,_______,                        QK_BOOT,KC_MINS,KC_EQL ,KC_QUOT,KC_GRV ,_______,
                      _______,_______,                                                        _______,_______,
                                      _______,_______,                        _______,_______,
                                      _______,_______,                        _______,_______,
                                      _______,_______,                        _______,_______
